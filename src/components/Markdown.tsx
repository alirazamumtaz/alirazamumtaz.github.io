...
/**
 * Markdown — shared post renderer ("Plain Sight" v2, design.md §3/§6).
 ...
 *   the .locus-markdown styles in index.css
 */
...
export default function Markdown({ markdown, className }: MarkdownProps) {
  ...
  return <div className={cn('locus-markdown', className)}>{renderBlocks(tokens)}</div>
}
